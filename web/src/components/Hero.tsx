      ...
      <div className="container mx-auto px-6 pt-24 pb-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-orange-600">your child's world</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 leading-relaxed max-w-xl">
                Where every Nepali parent can give their autistic child the
                daily therapy they need - with expert guidance right on their
                phone
              </p>
            </div>
          ...
          <div className="relative hidden lg:block h-[600px]">
            ...
            {/* </motion.div> */} *{/* Floating Card 2: Interactive Element */}
            <motion.div
