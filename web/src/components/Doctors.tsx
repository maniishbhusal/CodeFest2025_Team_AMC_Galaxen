...
const doctors = [
  {
    ...
    quote: "NeuroCare fills a critical gap in early intervention and autism care delivery in Nepal.",
  ...
  },
  {
    ...
    quote: "Daily routines are key to progress. NeuroCare makes consistency easy for families.",
