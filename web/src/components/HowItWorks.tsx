...
const steps = [
  ...
  },
  {
    ...
    checkpoints: ["Background Study", "M-Chat", "Video screening"],
    color: "text-blue-600",
    bgColor: "bg-blue-50",
  ...
  },
  {
    ...
    checkpoints: ["personal Information", "M-Chat Score", "EEG and MRI test"],
    color: "text-teal-600",
    bgColor: "bg-teal-50",
    ...
    <section className="py-24 bg-gradient-to-br from-slate-50 via-orange-50/20 to-blue-50/20 overflow-hidden relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-28">
          ...
          >
            From downloading the app to seeing your child smile at new
            milestones, we've made the process{" "}
            <span className="font-bold text-orange-600">intuitive</span>,
        ...
        <div className="relative">
          ...
          >
            ...
            <div>
              ...
              <span
                className={`text-sm font-bold uppercase tracking-wider ${step.color} font-sans`}
              >
                {step.subtitle}
              </span>
            </div>
      ...
      >
        ...
        >
          ...
          <div className="w-full h-full bg-white rounded-[3rem] overflow-hidden relative shadow-inner">
            ...
            <div
              className={`w-full h-full ${step.bgColor} flex items-center justify-center relative`}
            >
              <img
                src={step.image}
                alt={step.title}
